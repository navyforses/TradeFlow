#
# Dockerfile for an image with the currently checked out version of tradeflow installed. To build:
#
#    docker build -t quantopian/tradeflow .
#
# To run the container:
#
#    docker run -v /path/to/your/notebooks:/projects -v ~/.tradeflow:/root/.tradeflow -p 8888:8888/tcp --name tradeflow -it quantopian/tradeflow
#
...
#
#    docker exec -it tradeflow tradeflow run -f /projects/my_algo.py --start 2015-1-1 --end 2016-1-1 -o /projects/result.pickle
#
FROM python:3.5
...
#
# build and install tradeflow from source.  install TA-Lib after to ensure
# numpy is available.
#
...
#
# make port available. /tradeflow is made a volume
# for developer testing.
#
EXPOSE ${NOTEBOOK_PORT}

#
# build and install the tradeflow package into the image
#
