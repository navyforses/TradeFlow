...
history_algo = """
from tradeflow.api import sid, history
...
history_bts_algo = """
from tradeflow.api import sid, history, record
...
class TestAPIShim(WithCreateBarData,
    ...
    def test_old_new_data_api_paths(self):
        ...
        spot_value_meth = 'tradeflow.data.data_portal.DataPortal.get_spot_value'
        ...
        history_meth = 'tradeflow.data.data_portal.DataPortal.get_history_window'
