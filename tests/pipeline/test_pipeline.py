"""
Tests for tradeflow.pipeline.Pipeline
"""
...
from tradeflow.pipeline import Factor, Filter, Pipeline
from tradeflow.pipeline.data import Column, DataSet, USEquityPricing
...
from tradeflow.pipeline.graph import display_graph
from tradeflow.utils.compat import getargspec
...
class PipelineTestCase(TestCase):
    ...
    def test_show_graph(self):
        ...
        patch_display_graph = patch(
            'tradeflow.pipeline.graph.display_graph',
            mock_display_graph,
        )
