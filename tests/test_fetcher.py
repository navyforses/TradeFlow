...
from tradeflow.errors import UnsupportedOrderParameters
from tradeflow.sources.requests_csv import mask_requests_args
from tradeflow.utils import factory
from tradeflow.testing import FetcherDataPortal
...
class FetcherTestCase(WithResponses,
    ...
    def test_minutely_fetcher(self):
        ...
        test_algo = self.make_algo(
            script="""
from tradeflow.api import fetch_csv, record, sid
...
def handle_data(context, data):
    ...
    def test_fetch_csv_with_pure_signal_file(self):
        ...
        results = self.run_algo(
            """
from tradeflow.api import fetch_csv, sid, record
...
def handle_data(context, data):
    ...
    def test_sources_merge_custom_ticker(self):
        ...
        # correct.
        with patch('tradeflow.sources.requests_csv.PandasRequestsCSV.fetch_url',
                   new=capture_kwargs):
            results = self.run_algo(
                """
from tradeflow.api import fetch_csv, record, sid
...
from tradeflow.api import fetch_csv, record, sid, get_datetime
...
def handle_data(context, data):
    ...
    def test_fetcher_universe_non_security_return(self):
        ...
        self.run_algo(
            """
from tradeflow.api import fetch_csv
...
def handle_data(context, data):
    ...
    def test_order_against_data(self):
        ...
        with self.assertRaises(UnsupportedOrderParameters):
            self.run_algo("""
from tradeflow.api import fetch_csv, order, sid
...
def handle_data(context, data):
    ...
    def test_fetcher_universe_minute(self):
        ...
        results = self.run_algo(
            """
from pandas import Timestamp
from tradeflow.api import fetch_csv, record, get_datetime
...
def handle_data(context, data):
    ...
    def test_fetcher_in_before_trading_start(self):
        ...
        results = self.run_algo("""
from tradeflow.api import fetch_csv, record, symbol
...
""", sim_params=sim_params)
    ...
    def test_fetcher_bad_data(self):
        ...
        results = self.run_algo("""
from tradeflow.api import fetch_csv, symbol
import numpy as np
