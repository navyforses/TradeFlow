...
import tradeflow.__main__ as main
import tradeflow
from tradeflow.testing import ZiplineTestCase
from tradeflow.testing.fixtures import WithTmpDir
from tradeflow.testing.predicates import (
    assert_equal,
    assert_raises_str,
)
from click.testing import CliRunner
from tradeflow.extensions import (
    Namespace,
    create_args,
    parse_extension_arg,
)
...
class CmdLineTestCase(WithTmpDir, ZiplineTestCase):
    ...
    def test_user_input(self):
        tradeflow.extension_args = Namespace()
        ...
        assert_equal(tradeflow.extension_args.first.second.a, 'blah1')
        assert_equal(tradeflow.extension_args.first.second.b, 'blah2')
        assert_equal(tradeflow.extension_args.first.third, 'blah3')
        assert_equal(tradeflow.extension_args.second.a.b, 'blah4')
        assert_equal(tradeflow.extension_args.second.b.a, 'blah5')
        assert_equal(tradeflow.extension_args.a1, 'value1')
        assert_equal(tradeflow.extension_args.b_, 'value2')
