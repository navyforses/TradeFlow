...
import tradeflow.api as api
import tradeflow.errors as ze
from tradeflow.finance.execution import StopLimitOrder
import tradeflow.testing.fixtures as zf
from tradeflow.testing.predicates import assert_equal
import tradeflow.test_algorithms as zta
...
class TestOrderMethods(zf.WithConstantEquityMinuteBarData,
    ...
    def test_cannot_order_in_before_trading_start(self, order_method, amount):
        algotext = """
from tradeflow.api import sid, {order_func}
