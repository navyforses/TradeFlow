...
from tradeflow.utils.input_validation import preprocess
...
class AfterOpen(StatelessRule):
    ...
    <tradeflow.utils.events.AfterOpen object at ...>
    """
...
class BeforeClose(StatelessRule):
    ...
    <tradeflow.utils.events.BeforeClose object at ...>
    """
    def __init__(self, offset=None, **kwargs):
        self.offset = _build_offset(
            offset,
...
class date_rules(object):
    """
    Factories for date-based :func:`~tradeflow.api.schedule_function` rules.

    See Also
    --------
    :func:`~tradeflow.api.schedule_function`
    """
    ...
    def every_day():
        ...
        Returns
        -------
        rule : tradeflow.utils.events.EventRule
        """
        return Always()
...
class time_rules(object):
    """Factories for time-based :func:`~tradeflow.api.schedule_function` rules.
