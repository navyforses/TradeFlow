...
from tradeflow.utils.algo_instance import get_algo_instance, set_algo_instance
...
def api_method(f):
    ...
    # function (wrapped) to tradeflow.api
    @wraps(f)
    ...
    # Add functor to tradeflow.api
    setattr(tradeflow.api, f.__name__, wrapped)
    tradeflow.api.__all__.append(f.__name__)
