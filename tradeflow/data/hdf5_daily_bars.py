...
from tradeflow.utils.numpy_utils import bytes_array_to_native_str_object_array
from tradeflow.utils.pandas_utils import check_indexes_all_same
...
class HDF5DailyBarWriter(object):
    ...
    See Also
    --------
    tradeflow.data.hdf5_daily_bars.HDF5DailyBarReader
    """
...
class HDF5DailyBarReader(CurrencyAwareSessionBarReader):
    ...
    def trading_calendar(self):
        """
        Returns the tradeflow.utils.calendar.trading_calendar used to read
