...
from tradeflow.data.session_bars import CurrencyAwareSessionBarReader
from tradeflow.data.bar_reader import (
    NoDataAfterDate,
    NoDataBeforeDate,
    NoDataOnDate,
)
...
from tradeflow.utils.numpy_utils import iNaT, float64_dtype, uint32_dtype
from tradeflow.utils.memoize import lazyval
from tradeflow.utils.cli import maybe_show_progress
...
class BcolzDailyBarWriter(object):
    ...
    calendar : tradeflow.utils.calendar.trading_calendar
    ...
    See Also
    --------
    tradeflow.data.bcolz_daily_bars.BcolzDailyBarReader
    """
    _csv_dtypes = {
        'open': float64_dtype,
        'high': float64_dtype,
...
class BcolzDailyBarReader(CurrencyAwareSessionBarReader):
    ...
    See Also
    --------
    tradeflow.data.bcolz_daily_bars.BcolzDailyBarWriter
    """
