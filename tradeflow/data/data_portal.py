...
from tradeflow.data.continuous_future_reader import (
    ContinuousFutureSessionBarReader,
    ContinuousFutureMinuteBarReader
)
from tradeflow.assets.roll_finder import (
    CalendarRollFinder,
    VolumeRollFinder
)
from tradeflow.data.dispatch_bar_reader import (
    AssetDispatchMinuteBarReader,
    AssetDispatchSessionBarReader
)
from tradeflow.data.resample import (
    DailyHistoryAggregator,
    ReindexMinuteBarReader,
    ReindexSessionBarReader,
)
from tradeflow.data.history_loader import (
    DailyHistoryLoader,
    MinuteHistoryLoader,
)
from tradeflow.data.bar_reader import NoDataOnDate
from tradeflow.utils.math_utils import (
    nansum,
    nanmean,
    nanstd
)
from tradeflow.utils.memoize import remember_last, weak_lru_cache
from tradeflow.utils.pandas_utils import (
    normalize_date,
    timedelta_to_integral_minutes,
)
from tradeflow.errors import HistoryWindowStartsBeforeData
...
class DataPortal(object):
    ...
    Parameters
    ----------
    asset_finder : tradeflow.assets.assets.AssetFinder
        The AssetFinder instance used to resolve assets.
    trading_calendar: tradeflow.utils.calendar.exchange_calendar.TradingCalendar
    ...
    def get_history_window(self,
        ...
        Parameters
        ----------
        assets : list of tradeflow.data.Asset objects
