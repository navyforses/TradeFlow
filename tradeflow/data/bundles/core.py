...
from tradeflow.assets import AssetDBWriter, AssetFinder, ASSET_DB_VERSION
from tradeflow.assets.asset_db_migrations import downgrade
from tradeflow.utils.cache import (
    dataframe_cache,
    working_dir,
    working_file,
)
from tradeflow.utils.compat import ExitStack, mappingproxy
from tradeflow.utils.input_validation import ensure_timestamp, optionally
...
def _make_bundle_core():
    ...
    def register(name,
        ...
        See Also
        --------
        tradeflow.data.bundles.bundles
        """
        if name in bundles:
            warnings.warn(
