...
from tradeflow.data._resample import (
...
from tradeflow.data.minute_bars import MinuteBarReader
from tradeflow.data.session_bars import SessionBarReader
...
class ReindexBarReader(with_metaclass(ABCMeta)):
    ...
    - trading_calendar : tradeflow.utils.trading_calendar.TradingCalendar
