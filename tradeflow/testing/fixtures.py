...
import tradeflow
from tradeflow.algorithm import TradingAlgorithm
from tradeflow.assets import Equity, Future
from tradeflow.assets.continuous_futures import CHAIN_PREDICATES
from tradeflow.data.benchmarks import get_benchmark_returns_from_file
from tradeflow.data.fx import DEFAULT_FX_RATE
from tradeflow.finance.asset_restrictions import NoRestrictions
from tradeflow.utils.memoize import classlazyval
from tradeflow.pipeline import SimplePipelineEngine
from tradeflow.pipeline.data import USEquityPricing
from tradeflow.pipeline.data.testing import TestingDataSet
from tradeflow.pipeline.domain import GENERIC, US_EQUITIES
from tradeflow.pipeline.loaders import USEquityPricingLoader
from tradeflow.pipeline.loaders.testing import make_seeded_random_loader
from tradeflow.protocol import BarData
from tradeflow.utils.compat import ExitStack
from tradeflow.utils.paths import ensure_directory, ensure_directory_containing
from .core import (
...
zipline_dir = os.path.dirname(tradeflow.__file__)
...
class WithAssetFinder(WithDefaultDateBounds):
    ...
    See Also
    --------
    tradeflow.testing.make_simple_equity_info
    tradeflow.testing.make_jagged_equity_info
    tradeflow.testing.make_rotating_equity_info
    tradeflow.testing.make_future_info
    tradeflow.testing.make_commodity_future_info
    """
    ...
    def make_asset_finder(cls):
        ...
        Returns
        -------
        asset_finder : tradeflow.assets.AssetFinder
        """
...
class WithSimParams(WithDefaultDateBounds):
    ...
    See Also
    --------
    tradeflow.finance.trading.SimulationParameters
    """
...
class WithEquityDailyBarData(WithAssetFinder, WithTradingCalendars):
    ...
    tradeflow.testing.create_daily_bar_data
    """  # noqa
...
class WithFutureDailyBarData(WithAssetFinder, WithTradingCalendars):
    ...
    make_future_daily_bar_data() -> iterable[(int, pd.DataFrame)]
        ...
        :func:`~tradeflow.testing.create_daily_bar_data`
...
class WithBcolzEquityDailyBarReader(WithEquityDailyBarData, WithTmpDir):
    ...
    - `cls.bcolz_daily_bar_ctable` is populated with data returned from
      ...
      :func:`tradeflow.pipeline.loaders.synthetic.make_equity_daily_bar_data`.
...
class WithBcolzFutureDailyBarReader(WithFutureDailyBarData, WithTmpDir):
    ...
    - `cls.bcolz_daily_bar_ctable` is populated with data returned from
      ...
      :func:`tradeflow.pipeline.loaders.synthetic.make_future_daily_bar_data`.
...
class WithEquityMinuteBarData(WithAssetFinder, WithTradingCalendars):
    ...
    make_equity_minute_bar_data() -> iterable[(int, pd.DataFrame)]
        ...
        tradeflow.testing.core.create_minute_bar_data.

    See Also
    --------
    WithEquityDailyBarData
    tradeflow.testing.create_minute_bar_data
    """
...
class WithFutureMinuteBarData(WithAssetFinder, WithTradingCalendars):
    ...
    make_future_minute_bar_data() -> iterable[(int, pd.DataFrame)]
        ...
        :func:`~tradeflow.testing.create_minute_bar_data`
...
class WithBcolzEquityMinuteBarReader(WithEquityMinuteBarData, WithTmpDir):
    ...
    - `cls.bcolz_minute_bar_ctable` is populated with data returned from
      ...
      :func:`tradeflow.pipeline.loaders.synthetic.make_equity_minute_bar_data`.
...
class WithAdjustmentReader(WithBcolzEquityDailyBarReader):
    ...
    See Also
    --------
    tradeflow.testing.MockDailyBarReader
    """
    @classmethod
    def _make_data(cls):
        return None
...
class WithSeededRandomPipelineEngine(WithTradingSessions, WithAssetFinder):
    ...
    seeded_random_loader : SeededRandomLoader
        ...
        tradeflow.pipeline.data.testing.TestingDataSet.
    ...
    See Also
    --------
    tradeflow.pipeline.loaders.synthetic.SeededRandomLoader
    tradeflow.pipeline.loaders.testing.make_seeded_random_loader
    tradeflow.pipeline.engine.SimplePipelineEngine
    """
