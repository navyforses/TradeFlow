...
from tradeflow.assets import AssetFinder, AssetDBWriter
from tradeflow.assets.synthetic import make_simple_equity_info
from tradeflow.utils.compat import getargspec, wraps
from tradeflow.data.data_portal import DataPortal
from tradeflow.data.minute_bars import (
    BcolzMinuteBarReader,
    BcolzMinuteBarWriter,
    US_EQUITIES_MINUTES_PER_DAY
)
from tradeflow.data.bcolz_daily_bars import (
    BcolzDailyBarReader,
    BcolzDailyBarWriter,
)
...
from tradeflow.pipeline.data import EquityPricing
from tradeflow.pipeline.domain import EquitySessionDomain
from tradeflow.pipeline.engine import SimplePipelineEngine
from tradeflow.pipeline.factors import CustomFactor
from tradeflow.pipeline.loaders.testing import make_seeded_random_loader
from tradeflow.utils import security_list
from tradeflow.utils.input_validation import expect_dimensions
from tradeflow.utils.numpy_utils import as_column, isnat
from tradeflow.utils.pandas_utils import timedelta_to_integral_seconds
from tradeflow.utils.sentinel import sentinel
...
def all_pairs_matching_predicate(values, pred):
    ...
    Examples
    --------
    >>> from tradeflow.testing import all_pairs_matching_predicate
...
def subtest(iterator, *_names):
    ...
    Consider using ``tradeflow.testing.parameter_space`` when subtests
    ...
    * Have a large parameter space we are testing
    ...
    See Also
    --------
    tradeflow.testing.parameter_space
    """
    def dec(f):
        @wraps(f)
