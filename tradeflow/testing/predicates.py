...
from tradeflow.dispatch import dispatch
from tradeflow.lib.adjustment import Adjustment
from tradeflow.lib.labelarray import LabelArray
from tradeflow.testing.core import ensure_doctest
from tradeflow.utils.compat import getargspec, mappingproxy
from tradeflow.utils.formatting import s
from tradeflow.utils.functional import dzip_exact, instance
from tradeflow.utils.math_utils import tolerant_equals
...
class wildcard(object):
    ...
    This is useful when using :func:`~tradeflow.testing.predicates.assert_equal`
