...
:py:class:`tradeflow.lines.SimulatedTrading` zipline it must follow an
...
The algorithm must expose methods:
  ...
  - handle_data: method that accepts a :py:class:`tradeflow.protocol.BarData`
...
api_algo = """
from tradeflow.api import (order,
                         set_slippage,
                         FixedSlippage,
                         record,
                         sid)
...
from tradeflow.api import get_environment, order, symbol
...
record_variables = """
from tradeflow.api import record
...
call_with_kwargs = """
from tradeflow.api import symbol
...
empty_positions = """
from tradeflow.api import record, schedule_function, time_rules, date_rules, \
    symbol
...
set_benchmark_algo = """
from tradeflow.api import symbol, set_benchmark
