...
from tradeflow.finance.constants import FUTURE_EXCHANGE_FEES_BY_SYMBOL
...
class CommissionModel(with_metaclass(FinancialModelMeta)):
    ...
    :class:`~tradeflow.finance.commission.CommissionModel` and implement
    :meth:`calculate`.
    """
    ...
    def calculate(self, order, transaction):
        ...
        transaction : tradeflow.finance.transaction.Transaction
