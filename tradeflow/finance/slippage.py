...
from tradeflow.finance.constants import ROOT_SYMBOL_TO_ETA
from tradeflow.finance.shared import AllowedAssetMarker, FinancialModelMeta
from tradeflow.finance.transaction import create_transaction
from tradeflow.utils.cache import ExpiringCache
from tradeflow.utils.dummy import DummyMapping
...
def fill_price_worse_than_limit_price(fill_price, order):
    ...
    order: tradeflow.finance.order.Order
...
class SlippageModel(with_metaclass(FinancialModelMeta)):
    ...
    :class:`~tradeflow.finance.slippage.SlippageModel` and implement
    :meth:`process_order`.
    ...
    def process_order(self, data, order):
        ...
        Parameters
        ----------
        data : tradeflow.protocol.BarData
        ...
        Raises
        ------
        tradeflow.finance.slippage.LiquidityExceeded
