...
import tradeflow.utils.math_utils as zp_math
from tradeflow.errors import BadOrderParameters
from tradeflow.utils.compat import consistent_round
...
class MarketOrder(ExecutionStyle):
    ...
    This is the default for orders placed with :func:`~tradeflow.api.order`.
    """
