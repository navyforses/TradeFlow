...
from tradeflow.gens.sim_engine import SESSION_END
    ...
    def should_cancel(self, event):
        ...
        event : enum-value
            An event type, one of:
              - :data:`tradeflow.gens.sim_engine.BAR`
              - :data:`tradeflow.gens.sim_engine.DAY_START`
              - :data:`tradeflow.gens.sim_engine.DAY_END`
              - :data:`tradeflow.gens.sim_engine.MINUTE_END`
