...
from tradeflow.utils.enum import enum
from tradeflow.utils.numpy_utils import vectorized_is_element
...
class SecurityListRestrictions(Restrictions):
    ...
    Parameters
    ----------
    restrictions : tradeflow.utils.security_list.SecurityList
