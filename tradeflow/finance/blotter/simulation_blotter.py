...
from tradeflow.extensions import register
...
from tradeflow.finance.commission import (
...
""".strip().format(class_name=self.__class__.__name__,
    ...
    def order(self, asset, amount, style, order_id=None):
        ...
        style : tradeflow.finance.execution.ExecutionStyle
    ...
    def get_transactions(self, bar_data):
        ...
        Parameters
        ----------
        bar_data: tradeflow._protocol.BarData
