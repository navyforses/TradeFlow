...
import tradeflow
from tradeflow.data import bundles as bundles_module
from trading_calendars import get_calendar
from tradeflow.utils.compat import wraps
from tradeflow.utils.cli import Date, Timestamp
from tradeflow.utils.run_algo import _run, BenchmarkSpec, load_extensions
from tradeflow.extensions import create_args
...
@click.option(
    ...
    is_flag=True,
    default=True,
    help="Don't load the default zipline extension.py file in $TRADEFLOW_HOME.",
)
@click.option(
    '-x',
    multiple=True,
...
def main(ctx, extension, strict_extensions, default_extension, x):
    ...
    create_args(x, tradeflow.extension_args)
    load_extensions(
        default_extension,
        extension,
        strict_extensions,
