...
from . import api
from tradeflow import extensions as ext
...
# noticeably slower, which becomes particularly noticeable in the TradeFlow CLI.
...
if global_calendar_dispatcher._calendars:
    ...
    warnings.warn(
        ...
        "TradeFlow startup will be much slower until this is fixed!",
    )
    del warnings
...
def load_ipython_extension(ipython):
    from .__main__ import tradeflow_magic
    ipython.register_magic_function(zipline_magic, 'line_cell', 'tradeflow')
...
def setup(self,
    ...
    """Lives in tradeflow.__init__ for doctests."""
