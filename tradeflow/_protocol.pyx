...
cdef class BarData:
    ...
    :func:`~tradeflow.api.handle_data` and
    :func:`~tradeflow.api.before_trading_start`.
    ...
    restrictions : tradeflow.finance.asset_restrictions.Restrictions
    ...
    def current(self, assets, fields):
        ...
        Parameters
        ----------
        assets : tradeflow.assets.Asset or iterable of tradeflow.assets.Asset
...
cdef class InnerPosition:
    ...
    :class:`tradeflow.finance.position.Position` and a
    :class:`tradeflow.protocol.Position` at the same time without a cycle.
    """
    def __init__(self,
                 asset,
                 amount=0,
