...
from tradeflow.assets.asset_writer import write_version_info
from tradeflow.utils.compat import wraps
from tradeflow.errors import AssetDBImpossibleDowngrade
...
def alter_columns(op, name, *columns, **kwargs):
    ...
    *columns
    ...
    downgrade where ``tradeflow.assets.asset_db_schema`` could change.
    """
