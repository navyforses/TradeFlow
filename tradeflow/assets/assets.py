...
from tradeflow.utils.functional import invert
from tradeflow.utils.memoize import lazyval
from tradeflow.utils.numpy_utils import as_column
from tradeflow.utils.preprocess import preprocess
from tradeflow.utils.sqlite_utils import group_into_chunks, coerce_string_to_eng
...
class AssetFinder(object):
    ...
    See Also
    --------
    :class:`tradeflow.assets.AssetDBWriter`
    """
    ...
    def lifetimes(self, dates, include_start_date, country_codes):
        ...
        --------
        numpy.putmask
        tradeflow.pipeline.engine.SimplePipelineEngine._compute_root_mask
        """
