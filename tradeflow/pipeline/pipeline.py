...
class Pipeline(object):
    ...
    :class:`~tradeflow.pipeline.Term` instances, and 'screen', a
    :class:`~tradeflow.pipeline.Filter` representing criteria for
    ...
    columns : dict, optional
        Initial columns.
    screen : tradeflow.pipeline.Filter, optional
        Initial screen.
    """
    ...
    def columns(self):
        ...
        Returns
        -------
        columns : dict[str, tradeflow.pipeline.ComputableTerm]
    ...
    def screen(self):
        ...
        Returns
        -------
        screen : tradeflow.pipeline.Filter or None
    ...
    def add(self, term, name, overwrite=False):
        ...
        Parameters
        ----------
        column : tradeflow.pipeline.Term
    ...
    def remove(self, name):
        ...
        Returns
        -------
        removed : tradeflow.pipeline.Term
            The removed term.
        """
    ...
    def to_execution_plan(self,
        ...
        default_screen : tradeflow.pipeline.Term
    ...
    def to_simple_graph(self, default_screen):
        ...
        Returns
        -------
        graph : tradeflow.pipeline.graph.TermGraph
    ...
    def domain(self, default):
        ...
        Parameters
        ----------
        default : tradeflow.pipeline.domain.Domain
