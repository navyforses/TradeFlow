...
This module (tradeflow.pipeline.loaders.blaze) exports a function called
...
from tradeflow.pipeline.common import (
    AD_FIELD_NAME,
    SID_FIELD_NAME,
    TS_FIELD_NAME
)
from tradeflow.pipeline.data.dataset import DataSet, Column
from tradeflow.pipeline.domain import GENERIC
from tradeflow.pipeline.loaders.base import PipelineLoader
from tradeflow.pipeline.sentinels import NotSpecified
from tradeflow.lib.adjusted_array import can_represent_dtype
from tradeflow.utils.input_validation import expect_element
from tradeflow.utils.pandas_utils import ignore_pandas_nan_categorical_warning
from tradeflow.utils.pool import SequentialPool
try:
    ...
    def barf(*args, **kwargs):
        raise RuntimeError(
            "tradeflow.pipeline.loaders.blaze._core failed to import"
        )
...
class BlazeLoader(implements(PipelineLoader)):
    ...
    See Also
    --------
    :class:`tradeflow.utils.pool.SequentialPool`
    ...
    def register_dataset(self,
        ...
        See Also
        --------
        :func:`tradeflow.pipeline.loaders.blaze.from_blaze`
        """
        expr_data = ExprData(
            expr,
            deltas,
