...
from tradeflow.assets import Asset
...
from tradeflow.lib.adjusted_array import can_represent_dtype
from tradeflow.lib.labelarray import LabelArray
from tradeflow.utils.input_validation import expect_types
from tradeflow.utils.memoize import classlazyval, lazyval
...
from tradeflow.utils.sharedoc import (
    templated_docstring,
...
class Term(with_metaclass(ABCMeta, object)):
    ...
    :class:`tradeflow.pipeline.Pipeline`.
    ...
    - :class:`~tradeflow.pipeline.Factor`
    - :class:`~tradeflow.pipeline.Filter`
    - :class:`~tradeflow.pipeline.Classifier`
    ...
    **Example:**
    ...
    >>> from tradeflow.pipeline.factors import SimpleMovingAverage
    ...
    def mask(self):
        """
        A :class:`~tradeflow.pipeline.Filter` representing asset/date pairs to
...
class AssetExists(Term):
    ...
    See Also
    --------
    tradeflow.assets.AssetFinder.lifetimes
    """
    dtype = bool_dtype
    dataset = None
    inputs = ()
...
class LoadableTerm(Term):
    ...
    This is the base class for :class:`tradeflow.pipeline.data.BoundColumn`.
    """
    windowed = False
    inputs = ()
...
class ComputableTerm(Term):
    ...
    This is the base class for :class:`tradeflow.pipeline.Factor`,
    :class:`tradeflow.pipeline.Filter`, and :class:`tradeflow.pipeline.Classifier`.
    """
    inputs = NotSpecified
    ...
    def fillna(self, fill_value):
        ...
        Parameters
        ----------
        fill_value : tradeflow.pipeline.ComputableTerm, or object.
        ...
        **Filling with a Term:**
        ...
        Returns
        -------
        filled : tradeflow.pipeline.ComputableTerm
