from tradeflow.utils.compat import contextmanager as _contextmanager
...
class PipelineHooks(Interface):
    ...
    def computing_chunk(self, terms, start_date, end_date):
        ...
        Parameters
        ----------
        terms : list[tradeflow.pipeline.Term]
    ...
    def loading_terms(self, terms):
        ...
        Parameters
        ----------
        terms : list[tradeflow.pipeline.LoadableTerm]
            Terms being loaded.
        """
    ...
    def computing_term(self, term):
        ...
        Parameters
        ----------
        terms : tradeflow.pipeline.ComputableTerm
