...
from tradeflow.utils.formatting import bulleted_list
from tradeflow.utils.input_validation import expect_types, optional
...
Domain.__qualname__ = "tradeflow.pipeline.domain.Domain"
...
def infer_domain(terms):
    ...
    Parameters
    ----------
    terms : iterable[tradeflow.pipeline.Term]
