...
from tradeflow.pipeline.visualize import display_graph
...
class TermGraph(object):
    ...
    def _decref_dependencies_recursive(self, term, refcounts, garbage):
        ...
        should use:
        :meth:`~tradeflow.pipeline.graph.TermGraph.decref_dependencies`
        """
...
class ExecutionPlan(TermGraph):
    ...
    def offset(self):
        ...
        See Also
        --------
        :meth:`tradeflow.pipeline.graph.ExecutionPlan.offset`
        :meth:`tradeflow.pipeline.engine.ExecutionPlan.mask_and_dates_for_term`
        :meth:`tradeflow.pipeline.engine.SimplePipelineEngine._inputs_for_term`
        """
    ...
    def extra_rows(self):
        ...
        **as an input**.  This is not to be confused with `term.dependencies`,
        ...
        --------
        :meth:`tradeflow.pipeline.graph.ExecutionPlan.offset`
        :meth:`tradeflow.pipeline.Term.dependencies`
        """
        return {
