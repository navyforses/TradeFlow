...
from tradeflow.pipeline.mixins import SingleInputMixin
from tradeflow.utils.input_validation import expect_bounded
...
from tradeflow.utils.numpy_utils import rolling_window
...
class RSI(SingleInputMixin, CustomFactor):
    ...
    **Default Inputs**: :data:`tradeflow.pipeline.data.EquityPricing.close`
...
class Aroon(CustomFactor):
    ...
    **Defaults Inputs:** :data:`tradeflow.pipeline.data.EquityPricing.low`, \
                         :data:`tradeflow.pipeline.data.EquityPricing.high`
...
class FastStochasticOscillator(CustomFactor):
    ...
    **Default Inputs:** :data:`tradeflow.pipeline.data.EquityPricing.close`, \
                        :data:`tradeflow.pipeline.data.EquityPricing.low`, \
                        :data:`tradeflow.pipeline.data.EquityPricing.high`
...
class IchimokuKinkoHyo(CustomFactor):
    ...
    **Default Inputs:** :data:`tradeflow.pipeline.data.EquityPricing.high`, \
                        :data:`tradeflow.pipeline.data.EquityPricing.low`, \
                        :data:`tradeflow.pipeline.data.EquityPricing.close`
